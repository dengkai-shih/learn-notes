...
You need to connect the Snap's ```removable-media``` interface to allow it access to external drives Using get-iplayer snap version.... Open your terminal and run:
```sh
# jdownloader2
